...
## Step 2 - Manually add profile data sub-package
...
## Step 3 - Generalize manually added profile data sub-package
...
## Step 4 - Automatically add profile data sub-package
...
Copr will become the storage for our profile data sub-packages with all the rest of the regular packages.

After running this step using `make build-step5`, we're gonna have a project called: [kkleine/profile-data-collection](https://copr.fedorainfracloud.org/coprs/kkleine/profile-data-collection/).
...
In order for the Copr project to use our PGO instrumented LLVM we've made the repo available in the [`step5/Makefile`](step5/Makefile) using the `--repo` option.
