...
We test this using the {link-llvm-test-suite}:
...
The compile time on the other hand shows a performance improvement of *9.7%* when going from LLVM 16.0.3 to PGO optimized LLVM 16.0.2. The performance of linking was also improved by *1.3%*
...
But looking at the almost *10%* performance boost in compile time I really like how this experiment turned out. 
