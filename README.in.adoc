...
$ git clone https://github.com/kwk/pgo-experiment.git # <2>
$ cd pgo-experiment # <3>
$ git submodule init # <4>
$ git submodule update # <5>
----
...
<4> Update local configuration file.
<5> Fetch data from the submodule projects.
