...
The background script itself gathers all profiles that have been already written to the `TMPDIR` directory that we've specified link:#TMPDIR[here]:

.step2/myapp/pgo-background-merge.sh
[source,spec]
----
include::step2/myapp/pgo-background-merge.sh[tags=gather_profiles]
----
...
[source,spec]
----
include::step2/myapp/pgo-background-merge.sh[tag=get_profiles_in_use]
----
...
[source,spec]
----
include::step2/myapp/pgo-background-merge.sh[tags=get_ready_profiles]
----
...
We merge the raw profiles and then delete them in order to free up disk space. 

.step2/myapp/pgo-background-merge.sh
[source,spec]
----
include::step2/myapp/pgo-background-merge.sh[tags=merge]
----
